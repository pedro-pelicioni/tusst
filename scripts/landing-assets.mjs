...
const JOBS = [
  ...
  // "why learn it the old way": the golem scribe writes without end while the
  // apprentice reads the one contract before sealing it
  { src: "why-scene.png", out: "why/scene.webp", kind: "scene", budgetKB: 350, resize: { width: 2560 } },
