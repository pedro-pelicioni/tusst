// O Salão — home logada em /path: duas estradas + a Forja.
export const home = {
  ...
  doors: {
    ...
    forge: {
      ...
      title: "A Forja",
      blurb:
        "Labs guiados com botões que fazem coisas reais na testnet real — mais o IDE em modo livre. Sem login.",
      cta: "Entrar na Forja",
      progress: "{done} labs concluídos",
    },
  },
};
