...
export const landing = {
  ...
  hero: {
    ...
    ctaPrimary: "Começar a Campanha",
    ctaSecondary: "Abrir a Forja",
    ctaSecondaryBadge: "sem login",
    freeLine: "grátis · sem setup · no navegador",
    scrollHint: "descer",
  },
  intro: {
    ...
    badgeFree: "grátis · sem setup",
  },
  carousel: {
    kicker: "A Coleção",
    heading: "Campeões do Reino",
    body: "Oito cartas pintadas para oito atos. Feche o final de um ato e o campeão dele entra para a sua coleção — runs impecáveis rendem impressões raras.",
    previous: "Anterior",
    next: "Próximo",
    cards: {
      ...
      metaStroopbeholder: "ato vii · boss · aberração",
      metaStroopzipper: "ato viii · boss · arauto",
    },
  },
  features: {
    campaign: {
      ...
      body: "Da Cidadela Enferrujada ao Céu Reescrito: os atos abrem em ordem e as escaramuças aceitam tentativas para sempre. Marche dos fundamentos de Rust, pela lore da Stellar, até contratos implantados na testnet viva.",
      cta: "Começar no Ato I ›",
    },
    boss: {
      eyebrow: "Ato VII · o boss",
      titleTop: "O Covil",
      titleBottom: "do Beholder",
      body: "Além do Portão ele espera, numa fortaleza erguida com cada erro jamais tratado. Forje runas Soroban, implante-as no céu vivo e volte os contratos corrompidos dele contra ele mesmo.",
      note: "a carta dele não é recompensa. é troféu.",
    },
    forge: {
      eyebrow: "sem login · sem setup",
      titleTop: "A Forja",
      titleBottom: "Está Aberta",
      body: "Uma ferraria Soroban completa no navegador: escreva, compile, teste e implante contratos reais na testnet — com o Corvo, batedor do céu reescrito, grasnando dicas sempre que um run falha.",
      cta: "Abrir a Forja",
      ctaBadge: "sem login",
    },
  },
  ...
  a11y: {
    carouselLabel: "Campeões do reino",
    prevCard: "Campeão anterior",
    nextCard: "Próximo campeão",
