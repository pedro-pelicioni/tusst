...
// The Rust campaign — the OPTIONAL mastery road. This is the Mimo-style
// vertical rail that used to live at /path, moved verbatim when /path became
// the Hall; the unlock math and rail internals are unchanged on purpose
// (campaign gating must stay byte-compatible — see the v2 plan).
