...
Le prompt engineering demande *comment formuler*. Le **context engineering** pose la question plus importante : *qu'est-ce qui arrive devant le modèle, au juste ?*
...
- Les trois clauses de remboursement de la spécification (14 lignes) — pour que « correct » ait une définition qui ne soit pas l'avis du modèle.
...
- \`payments.rs\`, même si les remboursements vivent sous les paiements — ce n'est pas là qu'est le bug, et **tout fichier sur l'établi est un fichier que le modèle peut décider d'améliorer**.
...
Environ 210 lignes, face à un dépôt de quarante mille. Ce rapport *est* le métier.`,
    ...
    {
      kind: "quiz",
      question: `Vous envoyez le modèle corriger un bug dans le flux de remboursement. Qu'est-ce qui va sur l'établi ?`,
      options: [
...
- Un fichier parasite invite le modèle à y toucher « pour aider ».
...
La curation coupe dans les deux sens. **Retirer de l'établi est aussi puissant qu'y ajouter.**`,
    },
    {
      ...
      answer: 0,
      explain: `Le matériel sans rapport vous coûte de la place et de l'attention. Le matériel *contradictoire* vous coûte la justesse : le modèle n'a aucun moyen de savoir laquelle des deux versions de la vérité est l'actuelle, et sûr-de-lui-et-faux est le mode d'échec coûteux.`,
    },
    {
      kind: "fill",
      ...
      answer: 0,
      explain: `C'est le chapitre entier en une ligne. Formuler est une compétence qui se travaille en un après-midi ; décider de ce que le modèle ne voit jamais est la part qui reste difficile, et celle qui sépare un établi qui fonctionne d'un établi plein.`,
    },
    {
      kind: "theory",
      body: `## Pourquoi c'est le dernier chapitre tranquille

Jusqu'ici le modèle a fait une chose à la fois : vous montez l'établi, vous écrivez la demande, vous lisez la réponse. La boucle, c'est encore vous.
