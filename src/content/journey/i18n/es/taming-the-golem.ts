...
export const conceptText: JourneyConceptText = {
  ...
  steps: [
    {
      kind: "theory",
      body: `## El modelo a secas

Quita todo y un LLM hace exactamente una cosa: **texto entra, texto sale**. No puede ejecutar código, leer tu repositorio ni consultar la cadena.

Todo lo que lo convierte en un *trabajador* es el **arnés**: las herramientas que puede invocar, los archivos que puede tocar, el sandbox que lo contiene, los verificadores que juzgan su salida.
...
- **Paso de revisión** — donde un humano (u otro modelo) inspecciona el diff.
...
El rasgo más peligroso del modelo no es la ignorancia — es la **confianza mientras está equivocado**. Anuncia éxito con el mismo tono cálido tanto si el despliegue funcionó como si nunca ocurrió. La confianza es *estilo*, no señal.
...
- la **suite de pruebas** — tus pruebas, rojas o verdes
- el **linter** — ¿se mantuvieron los estándares?
- la **cadena misma** — ¿el libro mayor dice lo que el modelo afirma?`,
    },
    {
      kind: "quiz",
      question: `El modelo informa: "Contrato desplegado e inicializado con éxito." ¿Qué hace un arnés bien construido con esa frase?`,
      options: [
        ...
        "Le pide al modelo que revise cuidadosamente su propio trabajo en la misma sesión",
      ],
      answer: 0,
    ...
    { kind: "fill",
      ...
      file: "NOTES.md",
      before: `El modelo dice que el despliegue salió bien. Antes de que esa frase cambie nada, el arnés `,
      after: ` .`,
      choices: ["lee la cadena y comprueba", "le pide al modelo que lo confirme", "anota la afirmación en el registro de la ejecución", "repite el despliegue por si acaso"],
      answer: 0,
...
Ya sabes nombrar las piezas de un arnés y, más importante, negarte a creer nada de lo que el modelo diga sobre su propio trabajo.
...
**A continuación:** cuánto poder necesita de verdad el trabajo, y la única pregunta que hacerle a cada paso que construyas.` },
  ...
  testOut: [
    ...
    { question: `¿Cuál es el rasgo más peligroso del modelo?`,
    ...
    { question: `"Contrato desplegado e inicializado con éxito." ¿Qué hace un buen arnés con esa frase?`,
      options: ["La trata como una afirmación, lee la cadena, llama a una función de lectura y cree al libro mayor","La acepta — el modelo ha sido fiable hasta ahora","Le pide al modelo que revise su propio trabajo en la misma sesión"], answer: 0 },
  ],
};
