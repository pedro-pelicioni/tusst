...
Form yok. E-posta yok. İzin yok. Kimliğini saf matematikten *dövüyorsun* — ve önümüzdeki birkaç dakika içinde bu kimlik fon tutacak, bir varlığa güvenecek ve başka bir hesaba ödeme yapacak. Hepsi gerçek, **testnet** üzerinde: Stellar'ın deneme ağı; paralar oyuncak ama makine aynı.`,
    },
    "forge-keys": {
...
Bu adres herkese açık — gönül rahatlığıyla paylaş. Altındaki gizli anahtar senin adına imza atar; onu elinde tutan herkes *sen* olur. Testnet'te sorun değil. Mainnet'te ise gizli anahtarı asla paylaşma.`,
    },
    "friendbot": {
...
Testnet'te **Friendbot** adlı bir faucet, isteyen herkesi fonlar.`,
...
Maliyetine dikkat: minicik bir ücret (~0.00001 XLM) ve kilitlenen bir temel rezerv daha, çünkü trustline yeni bir ledger kaydı. Sıra numaran da bir tık ilerledi.`,
    ...
    "shrine": {
      title: "İkinci bir adres oluştur",
      body: `Boşluğa ödeme gönderemezsin — bir **hedef** lazım. İlk ödemeni alacak ikinci bir adres oluşturalım.

Onu üretip *gizli anahtarını çöpe atacağız*. Hesap var olacak ve gönderdiklerini tutacak, ama kimse onun adına asla imza atamayacak.`,
      cta: "Adresi oluştur",
      successBody: `İkinci adres:
...
Henüz ledger'da yok — tıpkı Friendbot'tan önceki senin gibi. Ama bu kez ona hayat veren **sen** olacaksın.`,
    ...
    "create-companion": {
      ...
      body: `Bir \`create_account\` operasyonu yeni bir adresi temel rezervin üstüne fonlar — Friendbot'un senin için yaptığının tam da aynısı. Şimdi bunu ikinci adres için **kendi** bakiyenden sen yapıyorsun: 100 testnet XLM'i.`,
      cta: "Oluştur (100 XLM gönder)",
      successBody: `Hesap oluşturuldu. Friendbot'un senin için yaptığını az önce sen yaptın — **hesaplar hesap yaratır**. Bütün hiyerarşi bu; kayıt memuru diye bir şey yok.`,
    },
    "payment": {
      title: "Bir ödeme gönder",
      ...
      cta: "25 XLM gönder",
      successBody: `Ödeme gönderildi — 25 XLM, kesin, geri alınamaz, kamu kaydında:
...
Ücret, sıra numarası artışı, iki bakiye güncellendi, bir ledger kapandı. Beş saniye. Stellar ödemesi işte bu.`,
    ...
    "quiz-recap": {
      ...
      explain: `Doğru. Trustline'lar hesap başına, varlık başınadır. Ana hesabın USDC'ye güveniyor; ikinci hesap yalnızca doğal XLM tutuyor. Ve gizli anahtarı çöpe atıldığından, kimse onun için asla bir tane açamaz.`,
    },
    "claim": {
